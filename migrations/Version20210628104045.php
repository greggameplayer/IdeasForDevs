 ...
 */
final class Version20210628104045 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD status_id INT DEFAULT NULL, DROP status');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE project ADD status INT NOT NULL, DROP status_id');
    }
}
